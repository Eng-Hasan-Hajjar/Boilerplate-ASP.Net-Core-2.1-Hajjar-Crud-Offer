...
namespace boilerplateasp.Roles
{
    ...
    public class RoleAppService : AsyncCrudAppService<Role, RoleDto, int, PagedRoleResultRequestDto, CreateRoleDto, RoleDto>, IRoleAppService
    {
        ...
        public async Task<ListResultDto<OffersListDto>> GetRolesAsync(GetRolesInput input)
        {
            ...
            return new ListResultDto<OffersListDto>(ObjectMapper.Map<List<OffersListDto>>(roles));
        }
